...
function take_Snapshot()
{
    ...
    classifier=ml5.imageClassifier('https://storage.googleapis.com/tm-model/XP1U--bIK/model.json',modelLoaded);
...
function check(){
    ...
    classifier.classify(img, gotResult);
            ...
            function gotResult(error, results) {
                ...
                document.getElementById("update_emoji").innerHTNL="&#128559"
                }
                if(results[0].label=="shocked"){
                document.getElementById("update_emoji2").innerHTNL="&#128561"
                }
